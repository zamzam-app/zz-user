...
export default function CreateCakePage() {
  ...
  const [inputValue, setInputValue] = useState('Happy Birthday');
  ...
  return (
    <div className='min-h-screen bg-[#FFF8F0] pb-32'>
      ...
      <div className='container mx-auto px-4 py-8 max-w-4xl'>
                  ...
                  <div className='p-8'>
                    <div className='text-center mb-8'>
                      ...
                      <p className='text-gray-500'>
                        Upload a picture from Pinterest, Instagram, or sketches.
                      </p>
                    </div>
                    <div className='max-w-xl mx-auto'>
                      <Dragger
                        multiple={false}
                        className='bg-gray-50 border-2 border-dashed border-[#D4AF37]/30 rounded-3xl p-10'
                      >
        ...
        {/* STICKY FOOTER */}
        <div className='fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 p-4 z-20 shadow-[0_-4px_10px_rgba(0,0,0,0.03)]'>
          <div className='container mx-auto max-w-4xl flex justify-between items-center gap-4'>
            <Button
              size='large'
              icon={<Download size={18} />}
              className='hidden md:flex rounded-xl h-12'
            >
              Download Design
            </Button>
            <Button
              ...
              type='primary'
              block
              className='bg-[#5D4037] hover:bg-[#4a322c] h-12 flex items-center justify-between px-6 rounded-xl'
      ...
      <style>{`
        .clip-heart { clip-path: path('M12 4.435c-1.989-5.399-12-4.597-12 3.568 0 4.06 3.06 6.06 12 13 8.94-6.94 12-8.94 12-13 0-8.165-10.011-8.967-12-3.568z'); transform: scale(1.2); display: inline-block; }
        .custom-tabs .ant-tabs-nav::before { display: none; }
      `}</style>
    </div>
  );
}
