...
import zamzam4 from '../../../public/__mocks__/reviews/r7.webp';
...
const Testimonials = () => {
  ...
  const testimonials: TestimonialCard[] = [
    {
      name: 'Abeesh Akhilesh',
      date: '6 months ago',
      rating: 5,
      image: zamzam4,
      imageAlt: 'Cozy ambience inside Zam Zam Bun Cafe',
      text: `Tried the Crackling bun, bomboloni, and butter cookie bun. Nice place for a date or catching up with friends and family.`,
    },
    {
      name: 'Kaveri A S',
      date: '5 months ago',
